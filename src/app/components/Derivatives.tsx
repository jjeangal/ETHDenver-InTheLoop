                    ...
                    <AccordionItem>
                        ...
                        <AccordionPanel pb={4}>
                            {requests.length > 0 ? requests.map((request) => (
                                <Box key={request.ipId.toString()} m={5} p={3} border="1px solid #ddd" backgroundColor="gray.800" borderRadius="md" boxShadow="md">
                    ...
                    <AccordionItem>
                        ...
                        <AccordionPanel pb={4}>
                            {demands.length > 0 ? demands.map((demand) => (
                                <Box key={demand.ipId.toString()} m={5} p={3} border="1px solid #ddd" backgroundColor="gray.800" borderRadius="md" boxShadow="md">
