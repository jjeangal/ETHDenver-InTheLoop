...
import {IStoryProtocolGateway} from "contracts/interfaces/IStoryProtocolGateway.sol";
...
contract IPHolder is IERC165, IERC1271, IERC721Receiver, IERC1155Receiver {
    ...
    function register(
        ...
        attributes[0] = Metadata.Attribute({
            key: "copyrightType",
            value: "literaryWork"
        });
    ...
    function mintAndRegisterIp(
        ...
        (tokenId, ipId) = spg.mintAndRegisterIpWithSig(
            policyId,
            tokenContract,
            tokenMetadata,
            ipMetadata,
